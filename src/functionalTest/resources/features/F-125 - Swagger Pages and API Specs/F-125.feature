...
Scenario: must show Swagger UI page APIs
    ...
    Given an appropriate test context as detailed in the test data source,
     ...
     When a request is prepared with appropriate values,
      And it is submitted to call the [Get Swagger UI Page] operation of [TS Translation Service],
...
Scenario: must show Swagger Json APIs
    ...
    Given an appropriate test context as detailed in the test data source,
     ...
     When a request is prepared with appropriate values,
      And it is submitted to call the [Get Swagger Json API] operation of [TS Translation Service],
